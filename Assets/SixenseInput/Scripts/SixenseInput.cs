...
public class SixenseInput : MonoBehaviour
{
	...
	{
        public const float PositionalUnitTranslation = 0.001f;
		/// <summary>
		...
		/// </summary>
        public Vector3 Position { get { return new Vector3(m_Position.x, m_Position.y, -m_Position.z) * PositionalUnitTranslation; } }
